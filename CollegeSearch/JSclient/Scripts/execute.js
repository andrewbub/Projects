	...
	for(i = 0; i < object.response.length; i++){
		...
		xhrschool.onload = function(e) {
			...
			// creating the different divs
                ...
                if (i%4 == 0 || i==0){
                    document.getElementById('schoolDiv'+i).setAttribute("style","clear: both; margin-left: 7%; margin-top: 3%; float: left; position: relative; background-color: #ffffff; border: 1px solid black; width: 20%; height: 40%; text-align: center;")
                } else {
                    document.getElementById('schoolDiv' + i).setAttribute("style", "float: left; position: relative; margin-left: 2%; margin-top: 3%; background-color: #ffffff; border: 1px solid black; width: 20%; height: 40%; text-align: center;")
                }
