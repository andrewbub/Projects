...
int main()
{
	...
	//	gfx_color(12, 139, 42); // grass
	//	gfx_fill_rectangle(0, 275, 500, 225);

	//	gfx_color(255, 255, 255); // lines
	//	gfx_fill_rectangle(0, 275, 500, 20); // back of endzone
	//	gfx_fill_rectangle(0, 390, 500, 5); // goal line
